...
mxG.Z["zh-tw"]["!?"]="!?";
mxG.Z["zh-tw"]["T"]="T";
mxG.Z["zh-tw"]["Good move"]="手筋";
mxG.Z["zh-tw"]["Bad move"]="惡手";
mxG.Z["zh-tw"]["Doubtful move"]="疑問手";
mxG.Z["zh-tw"]["Interesting move"]="有趣手";
mxG.Z["zh-tw"]["Good for Black"]="黑好";
mxG.Z["zh-tw"]["Good for White"]="白好";
mxG.Z["zh-tw"]["Even"]="兩分";
mxG.Z["zh-tw"]["Unclear"]="形勢不明";
mxG.Z["zh-tw"]["Turn in Sgf"]="輪誰走SGF裡";
mxG.Z["zh-tw"]["Symmetry"]="對稱";
mxG.Z["zh-tw"]["No symmetry"]="沒有";
mxG.Z["zh-tw"]["Horizontal mirror"]="水平";
mxG.Z["zh-tw"]["Vertical mirror"]="垂直";
mxG.Z["zh-tw"]["Rotate"]="迴轉";
...
mxG.Z["zh-tw"]["buildResult"]=function(a)
{
	...
	if (a.substr(1,1)=="+")
	{
		if (a.substr(2,1)=="R") b+=mxG.Z["zh-tw"][" by resign"]+mxG.Z["zh-tw"][" wins"];
		else if (a.substr(2,1)=="T") b+=mxG.Z["zh-tw"][" by time"]+mxG.Z["zh-tw"][" wins"];
		else if (a.substr(2,1)=="F") b+=mxG.Z["zh-tw"][" by forfeit"]+mxG.Z["zh-tw"][" wins"];
		else if (a.length>2) b+=mxG.Z["zh-tw"][" wins"]+parseFloat(a.substr(2).replace(",","."))+mxG.Z["zh-tw"][" point"];
		else b+=mxG.Z["zh-tw"][" wins"];
	}
	return b;
};
...
mxG.Z["zh-tw"]["Goban background (CSS color or JPG image):"]="棋盤背景（CSS顏色或JPEG圖像）";
mxG.Z["zh-tw"]["Line color (CSS color):"]="線顏色（CSS顏色）";
mxG.Z["zh-tw"]["Variation on focus color (CSS color):"]="焦點變化顏色（CSS顏色）";
mxG.Z["zh-tw"]["JPG images:"]="JPG圖像：";
