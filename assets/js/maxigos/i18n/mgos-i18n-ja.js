...
mxG.Z.ja["Turn in Sgf"]="黒番または白番はSGFに";
mxG.Z.ja["Symmetry"]="対称";
mxG.Z.ja["No symmetry"]="なし";
...
mxG.Z.ja["Zoom-"]="ズーム-";
mxG.Z.ja["Colors"]="色";
mxG.Z.ja["Goban background (CSS color or JPG image):"]="碁盤背景「CSS色、JPG画像」";
mxG.Z.ja["Line color (CSS color):"]="線色「CSS色」";
mxG.Z.ja["Variation on focus color (CSS color):"]="焦点に変化の色「CSS色」";
mxG.Z.ja["JPG images:"]="JPG画像：";
