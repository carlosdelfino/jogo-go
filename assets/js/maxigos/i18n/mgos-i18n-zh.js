...
mxG.Z.zh["!?"]="!?";
mxG.Z.zh["T"]="T";
mxG.Z.zh["Good move"]="手筋";
mxG.Z.zh["Bad move"]="恶手";
mxG.Z.zh["Doubtful move"]="疑问手";
mxG.Z.zh["Interesting move"]="有趣手";
mxG.Z.zh["Good for Black"]="黑好";
mxG.Z.zh["Good for White"]="白好";
mxG.Z.zh["Even"]="两分";
mxG.Z.zh["Unclear"]="形势不明";
mxG.Z.zh["Turn in Sgf"]="轮谁走SGF里";
mxG.Z.zh["Symmetry"]="对称";
mxG.Z.zh["No symmetry"]="没有";
mxG.Z.zh["Horizontal mirror"]="水平";
mxG.Z.zh["Vertical mirror"]="垂直";
mxG.Z.zh["Rotate"]="回转";
...
mxG.Z.zh["buildResult"]=function(a)
{
	...
	if (a.substr(1,1)=="+")
	{
		if (a.substr(2,1)=="R") b+=mxG.Z.zh[" by resign"]+mxG.Z.zh[" wins"];
		else if (a.substr(2,1)=="T") b+=mxG.Z.zh[" by time"]+mxG.Z.zh[" wins"];
		else if (a.substr(2,1)=="F") b+=mxG.Z.zh[" by forfeit"]+mxG.Z.zh[" wins"];
		else if (a.length>2) b+=mxG.Z.zh[" wins"]+parseFloat(a.substr(2).replace(",","."))+mxG.Z.zh[" point"];
		else b+=mxG.Z.zh[" wins"];
	}
	return b;
};
...
mxG.Z.zh["Event:"]="赛事名称:";
mxG.Z.zh["Round:"]="轮次:";
mxG.Z.zh["Black:"]="执黑者姓名:";
mxG.Z.zh["White:"]="执白者姓名:";
mxG.Z.zh["Rank:"]="等级:";
mxG.Z.zh["Komi:"]="贴目:";
mxG.Z.zh["Handicap:"]="授子:";
mxG.Z.zh["Result:"]="结果:";
...
mxG.Z.zh["Zoom-"]="缩小";
mxG.Z.zh["Colors"]="颜色";
mxG.Z.zh["Goban background (CSS color or JPG image):"]="棋盘背景（CSS颜色或JPG图像）";
mxG.Z.zh["Line color (CSS color):"]="线颜色（CSS颜色）";
mxG.Z.zh["Variation on focus color (CSS color):"]="焦点变化颜色（CSS颜色）";
mxG.Z.zh["JPG images:"]="JPG图像：";
